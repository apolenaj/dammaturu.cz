...
export function PublicNav() {
  ...
  return (
    <>
      {/* Horizontal nav only from lg — tablet keeps the menu to avoid header overflow */}
      <nav className="hidden min-w-0 lg:block" aria-label="Veřejná navigace">
      ...
      <div className="lg:hidden">
        ...
        {open ? (
          <div
            id={panelId}
            className="absolute inset-x-0 top-full max-w-[100vw] border-b border-line bg-paper-raised px-4 py-3 shadow-soft"
          >
            <NavLinkList
              items={publicNav}
              variant="sidebar"
